...
public class NTree<E> {
  ...
  // TODO: Doesn't completely work yet! Last 4 output is similar to hers but not quite!
  // Fix immediately!
  public void serialize(String fname) {
    ...
    while (!nodeQueue.isEmpty()) {
      ...
      // handle printing the node data and its parents
      Node temp = currentNode;
      String nodeOrder = "";
      while (temp != null) {
        nodeOrder = temp.data + " " + nodeOrder;
        temp = temp.parent;
      }

      System.out.println(nodeOrder.trim());

      for(int i = 0; i < currentNode.children.size(); i++) {
        nodeQueue.add(currentNode.children.get(i));
      }
    }
  }
  ...
  public static void main(String [] args) {
    try {
      ...
      */
      ...
      // TODO: delete later. Testing serialize. Passing in dummy data for testing
      foodtree.serialize("foo");
    } catch (Exception e) {
      e.printStackTrace();
    }	
  }
